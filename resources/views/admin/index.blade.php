  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-end me-3 rotate-caret  bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header justify-between ">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
        ...
        <span class="me-1 font-weight-bold text-white">مجلة العلوم الشاملة </span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link " href="{{route('departments')}}">
            ...
            <span class="nav-link-text me-1">ادارة التخصصات</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="{{route('researches')}}">
            ...
            <span class="nav-link-text me-1">ادارة البحوث</span>
          </a>
        </li>
      </ul>
    </div>
    <div class="sidenav-footer position-absolute w-100 bottom-0 ">
      <div class="mx-3">
        <a class="btn bg-gradient-dark mt-4 w-100" href="" type="button">موقع المجلة</a>
      </div>
    </div>
  </aside>
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 px-0" id="navbar">
          ...
          <!-- Settings Dropdown -->
          <div class="hidden sm:flex sm:items-center sm:ms-6 container">
            <!-- Teams Dropdown -->
