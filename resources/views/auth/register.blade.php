    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-input id="degree" class="block mt-1 w-full" type="text" name="degree" :value="old('degree')" required autofocus autocomplete="degree" />
            </div>
            <div>
                <x-label for="Workplace" value="{{ __('Workplace') }}" />
                <x-input id="Workplace" class="block mt-1 w-full" type="text" name="Workplace" :value="old('Workplace')" required autofocus autocomplete="Workplace" />
            </div>
            <div class="mt-4">
